...
void main() {
  test('fromEpochMilliseconds(...)', () {
    ...
    print(datetime);
    final other = ZonedDateTime.fromEpochMilliseconds(
        Timezone('America/Detroit'), datetime.epochMilliseconds);
    ...
    expect(timezone.id, 'America/Detroit');
  ...
  test('fromEpochMicroseconds(...)', () {
    final datetime = ZonedDateTime('America/Detroit', 2023, 3, 12, 2);
    final other = ZonedDateTime.fromEpochMicroseconds(
        Timezone('America/Detroit'), datetime.epochMicroseconds);
    final timezone = other.timezone;
    // final span = other.span;
  ...
  test('now()', () {
    ...
    expect(
        zoned.epochMicroseconds, closeTo(native.microsecondsSinceEpoch, 10000));
  ...
  group('from(...)', () {
    test('values', () {
      final datetime = ZonedDateTime.from(
          Timezone('America/Detroit'), 2023, 3, 12, 2, 3, 4, 5, 6);
      final other = ZonedDateTime.fromEpochMicroseconds(
          Timezone('America/Detroit'), datetime.epochMicroseconds);
      ...
      expect(
          datetime.epochMicroseconds, closeTo(other.epochMicroseconds, 10000));
      expect(datetime.toString(),
          '2023-03-12T03:03:04.005006-04:00[America/Detroit]');
  ...
  group('ZonedDateTime(...)', () {
    test('values', () {
      final datetime =
          ZonedDateTime('America/Detroit', 2023, 3, 12, 2, 3, 4, 5, 6);
      final other = ZonedDateTime.fromEpochMicroseconds(
          Timezone('America/Detroit'), datetime.epochMicroseconds);
      final timezone = datetime.timezone;
      // final span = datetime.span;
  ...
  for (final (unit, truncated) in [
    ...
    (
      ...
      ZonedDateTime('America/Detroit', 10, 2, 3, 4, 5, 6, 7)
    ),
    (
      TimeUnit.microseconds,
      ZonedDateTime('America/Detroit', 10, 2, 3, 4, 5, 6, 7, 8)
    ),
  ]) {
    final date = ZonedDateTime('America/Detroit', 10, 2, 3, 4, 5, 6, 7, 8);
    test('truncate to $unit',
        () => expect(date.truncate(to: unit as TemporalUnit), truncated));
  }

  for (final (date, unit, truncated) in [
    (
      ZonedDateTime('America/Detroit', 3, 2),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 7, 2),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 3, 2),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 7, 2),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 3, 2),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 7, 2),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 3, 2),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 7, 2),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
    ...
    test('round $unit to 5',
        () => expect(date.round(unit as TemporalUnit, 5), truncated));
  }

  for (final (date, unit, truncated) in [
    (
      ZonedDateTime('America/Detroit', 2, 9),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 4, 9),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 2, 9),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 4, 9),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 2, 9),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 4, 9),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 2, 9),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 4, 9),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
    ...
    test('ceil $unit to 5',
        () => expect(date.ceil(unit as TemporalUnit, 5), truncated));
  }

  for (final (date, unit, truncated) in [
    (
      ZonedDateTime('America/Detroit', 6, 2),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 9, 2),
      DateUnit.years,
      ZonedDateTime('America/Detroit', 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 6, 2),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 9, 2),
      DateUnit.months,
      ZonedDateTime('America/Detroit', 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 6, 2),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 9, 2),
      DateUnit.days,
      ZonedDateTime('America/Detroit', 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 6, 2),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
      ZonedDateTime('America/Detroit', 1, 1, 1, 9, 2),
      TimeUnit.hours,
      ZonedDateTime('America/Detroit', 1, 1, 1, 5)
    ),
    (
    ...
    test('floor $unit to 5',
        () => expect(date.floor(unit as TemporalUnit, 5), truncated));
  }
  ...
  group('difference(...)', () {
    group('DST', () {
      ...
      test('positive',
          () => expect(summer.difference(winter), const Duration(hours: 23)));

      test('negative',
          () => expect(winter.difference(summer), const Duration(hours: -23)));
    });
    ...
    group('non-DST', () {
      ...
      test('negative',
          () => expect(before.difference(after), const Duration(days: -1)));
    });
  });

  test(
      'toLocal()',
      () => expect(ZonedDateTime('America/Detroit', 2023, 5, 13).toLocal(),
          LocalDateTime(2023, 5, 13)));
  ...
  group('isBefore(...)', () {
    ...
    test('same timezone, same moment',
        () => expect(first.isBefore(first), false));

    test('same timezone, after', () => expect(second.isBefore(first), false));

    test('different timezone, before',
        () => expect(first.isBefore(other), true));

    test('different timezone, same moment',
        () => expect(second.isBefore(other), false));

    test('different timezone, after',
        () => expect(other.isBefore(first), false));
  });
  ...
  group('isSameMomentAs(...)', () {
    ...
    test('same timezone, before',
        () => expect(first.isSameMomentAs(second), false));

    test('same timezone, same moment',
        () => expect(first.isSameMomentAs(first), true));

    test('same timezone, after',
        () => expect(second.isSameMomentAs(first), false));

    test('different timezone, before',
        () => expect(first.isSameMomentAs(other), false));

    test('different timezone, same moment',
        () => expect(second.isSameMomentAs(other), true));

    test('different timezone, after',
        () => expect(other.isSameMomentAs(first), false));
  });
  ...
  group('isAfter(...)', () {
    ...
    test('different timezone, before',
        () => expect(first.isAfter(other), false));

    test('different timezone, same moment',
        () => expect(second.isAfter(other), false));
  ...
  test('toString()', () {
    ...
    expect(
        date.toString(), '2023-03-12T03:03:04.005006-04:00[America/Detroit]');
  });

  test(
      'weekday', () => expect(ZonedDateTime(singapore, 2023, 5, 3).weekday, 3));

  group('weekOfYear', () {
    test('last week of previous year',
        () => expect(ZonedDateTime(singapore, 2023).weekOfYear, 52));

    test('first of year',
        () => expect(ZonedDateTime(singapore, 2023, 1, 2).weekOfYear, 1));

    test('middle of year',
        () => expect(ZonedDateTime(singapore, 2023, 6, 15).weekOfYear, 24));

    test('short year last week',
        () => expect(ZonedDateTime(singapore, 2023, 12, 31).weekOfYear, 52));

    test('long year last week',
        () => expect(ZonedDateTime(singapore, 2020, 12, 31).weekOfYear, 53));
  });

  group('dayOfYear(...)', () {
    test('leap year first day',
        () => expect(ZonedDateTime(singapore, 2020).dayOfYear, 1));

    test('leap year before February',
        () => expect(ZonedDateTime(singapore, 2020, 2, 20).dayOfYear, 51));

    test('leap year after February',
        () => expect(ZonedDateTime(singapore, 2020, 3, 20).dayOfYear, 80));

    test('leap year last day',
        () => expect(ZonedDateTime(singapore, 2020, 12, 31).dayOfYear, 366));

    test('non-leap year first day',
        () => expect(ZonedDateTime(singapore, 2021).dayOfYear, 1));

    test('non-leap year',
        () => expect(ZonedDateTime(singapore, 2021, 3, 20).dayOfYear, 79));

    test('non-leap year last day',
        () => expect(ZonedDateTime(singapore, 2021, 12, 31).dayOfYear, 365));
  });

  group('firstDayOfWeek', () {
    test(
        'current date',
        () => expect(ZonedDateTime(singapore, 2023, 5, 8, 1).firstDayOfWeek,
            ZonedDateTime(singapore, 2023, 5, 8)));

    test(
        'last day of week',
        () => expect(ZonedDateTime(singapore, 2023, 5, 14, 1).firstDayOfWeek,
            ZonedDateTime(singapore, 2023, 5, 8)));

    test(
        'across months',
        () => expect(ZonedDateTime(singapore, 2023, 6, 2).firstDayOfWeek,
            ZonedDateTime(singapore, 2023, 5, 29)));
  });

  group('lastDayOfWeek', () {
    test(
        'current date',
        () => expect(ZonedDateTime(singapore, 2023, 5, 8, 1).lastDayOfWeek,
            ZonedDateTime(singapore, 2023, 5, 14)));

    test(
        'last day of week',
        () => expect(ZonedDateTime(singapore, 2023, 5, 14, 1).lastDayOfWeek,
            ZonedDateTime(singapore, 2023, 5, 14)));

    test(
        'across months',
        () => expect(ZonedDateTime(singapore, 2023, 5, 29).lastDayOfWeek,
            ZonedDateTime(singapore, 2023, 6, 4)));
  });

  group('firstDayOfMonth', () {
    test(
        'current date',
        () => expect(ZonedDateTime(singapore, 2023, 5, 1, 1).firstDayOfMonth,
            ZonedDateTime(singapore, 2023, 5)));

    test(
        'last day of the month',
        () => expect(ZonedDateTime(singapore, 2023, 5, 31).firstDayOfMonth,
            ZonedDateTime(singapore, 2023, 5)));
  });
  ...
  group('lastDayOfMonth', () {
    test(
        'current date',
        () => expect(ZonedDateTime(singapore, 2023, 2, 28).lastDayOfMonth,
            ZonedDateTime(singapore, 2023, 2, 28)));

    test(
        'first day of the month',
        () => expect(ZonedDateTime(singapore, 2023, 2).lastDayOfMonth,
            ZonedDateTime(singapore, 2023, 2, 28)));

    test(
        'leap year',
        () => expect(ZonedDateTime(singapore, 2020, 2).lastDayOfMonth,
            ZonedDateTime(singapore, 2020, 2, 29)));
  });

  group('daysInMonth', () {
    test('leap year',
        () => expect(ZonedDateTime(singapore, 2020, 2).daysInMonth, 29));

    test('non-leap year',
        () => expect(ZonedDateTime(singapore, 2021, 2).daysInMonth, 28));
  });

  group('leapYear', () {
    test('leap year',
        () => expect(ZonedDateTime(singapore, 2020).leapYear, true));

    test('non-leap year',
        () => expect(ZonedDateTime(singapore, 2021).leapYear, false));
  });

  test(
      'epochMilliseconds',
      () => expect(
            ZonedDateTime(singapore, 2023, 1, 2, 3, 4, 5, 6, 7)
                .epochMilliseconds,
